...
{  
    JLabel l, timerLabel, feedbackLabel;  
    ...
    {  
        ...
        {  
            ...
            add(jb[i]);  
            bg.add(jb[i]);  
            jb[i].addActionListener(this); // Add action listener to radio buttons
        }  
        b1=new JButton("Next");  
        ...
        timerLabel.setBounds(30, 10, 200, 20);  
        feedbackLabel.setBounds(30, 270, 400, 30);  
            ...
            public void actionPerformed(ActionEvent e) {  
                ...
                if (timeLeft <= 0) {  
                    ...
                    if (current < 9) {  
                        ...
                        JOptionPane.showMessageDialog(null, "Test completed. Correct answers: " + count);  
                        System.exit(0);  
                    }  
                }  
            }  
